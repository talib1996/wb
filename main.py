...
from PyQt5.QtWidgets import QApplication, QMainWindow, QMessageBox, QInputDialog, QShortcut, QDialog
...
import datetime, sys, os, serial
try:
    from ctypes import windll  # Only exists on Windows.
    myappid = 'chughtaitech.weightbridge.subproduct.version'
...
if __name__ == "__main__":
    app = QApplication([])
    app.setWindowIcon(QtGui.QIcon(os.path.join(basedir, './test9.svg')))
    window = Main_Class()
    window.show()
    app.exec_()
